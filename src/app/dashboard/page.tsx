...
export default function Home() {
  return (
    <>
      <Navbar />
      <div className="min-h-screen dark:bg-white scroll-smooth overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-400 [&::-webkit-scrollbar-thumb]:rounded-full">
